...
class CustomLogger(logging.Logger):
    def __init__(self, name: str, logging_config: LoggingConfig = LoggingConfig()) -> None:
        ...
        if logging_config.file_log_name is not None and logging_config.file_log_level is not None:
